...
/**
 * 实现简单的Actor架构功能展示2
 * 实现有Scout星探、Academy明星公司、Star明星、Director导演、CastingAssistant和ProductionAssistant 拍摄和制作助手
 *
 * Created by taisenki on 2016/8/23.
 */
object ActorSimple3 extends App {
  ...
  class Star(name: String, lifespan: FiniteDuration) extends Actor {
    ...
    def booked: Receive = {
      ...
      case RoleComplete => if (sender == acceptedOffer) context become receive
    }
  }
